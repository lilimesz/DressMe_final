...
class ColorUtils {
    ...
    private ArrayList<ColorName> initColorList() {
        ...
        colorList.add(new ColorName("Gainsborough", 0xDC, 0xDC, 0xDC));
        ...
        colorList.add(new ColorName("Light SeaGreen", 0x20, 0xB2, 0xAA));
        colorList.add(new ColorName("Light SkyBlue", 0x87, 0xCE, 0xFA));
        colorList.add(new ColorName("Light SlateGray", 0x77, 0x88, 0x99));
        colorList.add(new ColorName("Light SteelBlue", 0xB0, 0xC4, 0xDE));
        ...
        colorList.add(new ColorName("Pale VioletRed", 0xDB, 0x70, 0x93));
